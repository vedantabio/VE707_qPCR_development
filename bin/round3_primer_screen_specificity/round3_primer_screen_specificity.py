...
data_dir = '../../data/round3_primer_screen_specificity/'
result_dir = '../../results/round3_primer_screen_specificity/'

data = pd.read_excel(data_dir+'SAE_707_primer_screen_round3_specificity_11_12_24_20241112_174240_Results_20241205_142735.xlsx',header=25)
...
for strain in data['Target'].unique():
    strain_data = data.loc[data['Target']==strain,:]
    fig, ax = plt.subplots()
    if strain in ['31','42']:
        fig.set_size_inches(12,5)
    colors = sns.color_palette("Set2")
    sns.barplot(data=strain_data, x='primer', y='Cq',ax=ax, palette=colors ,hue='Sample')
    plt.axhline(y=41,color='r',linestyle='--',label='Undetermined (Cq = 41)')
